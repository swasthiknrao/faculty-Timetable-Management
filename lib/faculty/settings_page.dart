...
class _FacultySettingsPageState extends State<FacultySettingsPage> {
              ...
              _buildSection(
                ...
                children: [
                  ...
                  _buildSettingsTile(
                    ...
                    subtitle: 'Update your login username',
                ...
                children: [
                  Container(
                    ...
                    child: _profileImage == null
                        ? Icon(Icons.person,
                            color: themeProvider.accentColor, size: 40)
                        : null,
                  ),
                  Positioned(
                    right: 0,
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(
                            color: themeProvider.backgroundColor, width: 2),
                      ),
  ...
  void _showEditProfileDialog(BuildContext context) {
    final nameController = TextEditingController(text: widget.facultyName);
    final emailController = TextEditingController(
        text:
            '${widget.facultyName.toLowerCase().replaceAll(' ', '.')}@college.edu');
    final phoneController = TextEditingController(text: '9876543210');
    final dobController = TextEditingController(text: '01/01/1990');
    final experienceController = TextEditingController(text: '10 years');
    final qualificationsController =
        TextEditingController(text: 'Ph.D. in Computer Science');
    String selectedDesignation = 'Assistant Professor'; // Default value
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                ...
                if (currentUsernameController.text.isEmpty ||
                ...
                bool isVerified = await _verifyCredentials(
                  currentUsernameController.text,
